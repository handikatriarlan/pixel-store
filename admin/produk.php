						...
						<tbody>
							<tr>
								...
								if($result){
									...
									<td><a href="produk-edit.php?id=<?php echo $obj->id_produk ?>"><span class="status completed">Edit</span><br><br>
									<a href="produk-hapus.php?id=<?php echo $obj->id_produk ?>"><span class="status pending">Hapus</span></td>
							</tr>
						</tbody>
							<?php 
							}
